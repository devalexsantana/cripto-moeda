...
export function Home() {
    ...
    useEffect(() => {
        function getData() {
             fetch('https://sujeitoprogramador.com/api-cripto/?key=5ad51734f8020e33')
                ...
                <tbody id='tbody'>
                    {coins.map(coin => (
                        ...
                        <tr key={coin.name} className={styles.tr}>
                            ...
                            <td className={coin.delta_24h >= "0" ? styles.tdProfit:styles.tdLoss} data-label="Volume">
